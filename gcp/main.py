...
BUCKET_NAME = "breast-cancer-codebasics-tf-models"
...
def predict(request):
    global model
    if model is None:
        download_blob(BUCKET_NAME, "models/predict_breast_cancer_version1.h5", "/tmp/predict_breast_cancer_version1.h5")
        model = tf.keras.models.load_model("/tmp/predict_breast_cancer_version1.h5")
